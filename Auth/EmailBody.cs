namespace JWTRefreshToken.UtilityService
{
...
//color:white:border-radious:4px;display:block;margin:0 auto;width:50%;text-align:center;text-decoration:none"""">Reset Password1</a>
<a href=' + Url.Action(http://localhost:4200/reset?email={{{{email}}}}&code={{{{emailToken}}}}, http) + '>Reset Password2</a>;
<br>
